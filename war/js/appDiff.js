// timeline_edit and dao are added for editing
// timeline_view, chapter_viewer and common are also used in timelineViewer
Sandbox(["timeline_view", "timeline_edit", "chapter_viewer", "common", "dao"], function (app) {
        ...
        makeControlsToggle = function controlsToggle(containerClass, controlsClass, displayVal) {
            return function($UIevent) {
                ...
                if (!$element.hasClass(containerClass)) {
                    $element = $element.parents("."+containerClass);
                }
    ...
    hideEventControls = makeControlsToggle("eventControls", "eventControls", "none");
...
/**
	* MARKER *
	    ...
	    // probably can remove this, but need to make sure chapters are added
