var SimileAjax=SimileAjax||{loaded:false,loadingScriptsCount:0,error:null,params:{bundle:"true"},Platform:{},urlPrefix:"timelineResources/"};/* jquery-1.2.6.min.js */
...
window.Timeline=window.Timeline||{DateTime:window.SimileAjax.DateTime,serverLocale:"en",clientLocale:"en",urlPrefix:"timelineResources/"};/* band.js */
...
Timeline.GregorianDateLabeller.monthNames.en=["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"];Timeline.GregorianDateLabeller.dayNames.en=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"];Timeline.strings.en={wikiLinkLabel:"Discuss"};