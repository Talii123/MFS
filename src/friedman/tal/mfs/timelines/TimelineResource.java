...
//	@Consumes(Utils.HTML_FORM_MEDIATYPE)
	...
	public ITimeline createTimeline(MultivaluedMap<String, String> aTimelineSpecForm) {
	...
	private ITimeline createTimeline(String timelineID, SharingOption aSharingSetting) {
