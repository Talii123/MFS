...
public class QuerySpec<T> {
	...
	public QuerySpec(Class<T> aJDOClass, String aFilterString, String aParametersString, String anOrderingString, String aRangeString) {
		this._properties = Utils.newMap();
		this._theJDOClass = aJDOClass;
		
		setFilter(aFilterString);
		setParameters(aParametersString);
		setOrdering(anOrderingString);
		setRange(aRangeString);
	}
